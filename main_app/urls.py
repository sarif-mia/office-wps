...
urlpatterns = [
    ...
    path("device/add/", ceo_views.add_device, name='add_device'),
    path("device/manage/", ceo_views.manage_device, name='manage_device'),
    path("device/edit/<int:device_id>", ceo_views.edit_device, name='edit_device'),
    path("device/delete/<int:device_id>", ceo_views.delete_device, name='delete_device'),
